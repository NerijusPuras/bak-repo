        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contributions_Lectures_LectureId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    SlideId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Text = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Answers_Slides_SlideId",
                        column: x => x.SlideId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Answers_SlideId",
                table: "Answers",
                column: "SlideId");

            migrationBuilder.CreateIndex(
                name: "IX_Contributions_LectureId",
                table: "Contributions",
                column: "LectureId");
